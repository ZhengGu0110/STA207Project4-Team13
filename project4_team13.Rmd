...
plot(x=c(1,2,3,4), xaxt = "n", learnCurve$trainError,type = "o",col = "red", xlab = "Training set size, as percentage",
          ylab = "Error Rate", ylim = c(0.08,0.19))
lines(x=c(1,2,3,4), xaxt = "n", learnCurve$cvError, type = "o", col = "blue",ylim = c(0.08,0.19))
axis(1, at=1:4, labels= proportion)
legend('topright', c("Train error", "Test error"), lty = c(1,1), lwd = c(2.5, 2.5),
       col = c("red", "blue"))
